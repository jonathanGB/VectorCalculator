...
<html>
	<head>
		...
		<meta name="description" content="Useful and efficient tool for common vector algebra problems" />
		<meta name="keywords" content="vector, conversion, addition, algebra, scalar product, dot product, cross product, triple product, angle conversion" />
		<title> Vector calculator - addition, angle conversion and vectors products </title>
		...
		<div class="container">
			<header class="row">
				<div class="col-xs-12 col-md-12 col-sm-12 col-xs-12">
					...
					<a href="index.php"><button id="language-selector" type="button" class="btn btn-info">Français</button></a>
			...
			<div class="row" id="selection">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<ul id="onglets" class="nav nav-tabs nav-justified" role="tablist">
					  <li class="active"><a href="#mod" data-toggle="tab"> addition (polar) </a></li>
					  <li><a href="#com" data-toggle="tab"> addition (components) </a></li>
					  <li><a href="#con" data-toggle="tab"> angle conversion </a></li>
					  <li><a href="#mul" data-toggle="tab"> product </a></li>
					  <li><a href="#uni" data-toggle="tab"> unit vector </a></li>
					</ul>
					<div class="tab-content">
							...
							<div class="mode-selector" id="selectMode">
								 ...
								 <div class="btn-group" data-toggle="buttons">
									 ...
									 <label class="btn btn-default" id="deg"> 
									 	<input type="radio" name="inlineRadioOptions" value="deg"> Degrees 
									 </label>
								 </div>	 
							</div>
							<div class="mode-selector formatReponse" id="format">
								 <span class="mode"><b>Answer format</b> </span>
								 <div class="btn-group" data-toggle="buttons">
									 <label class="btn btn-default" id="polaire"> 
									 	<input type="radio" name="inlineRadioOptions" value="rad"> Polar
									 </label>
									 <label class="btn btn-default" id="composantes"> 
									 	<input type="radio" name="inlineRadioOptions" value="deg"> Components
									 </label>
								 </div>	 
							</div>
						</div>
					    ...
					    <div id="mod" class="tab-pane fade in active">
					    	<div id="resetInputs1">
								<button type="button" class="btn btn-default"> Empty table</button>
							</div>
					        ...
					        <table class="table table-bordered table-striped form-inline">
					        	...
					        	<tbody class="form-inline">
					        		<tr>
					        			...
					        			<td><input class="form-control" id="orie0" type="text" maxlength="20"><span> °</span></td>
					        		</tr>
					        		<tr>
					        			<td><span class="italic">v</span><sub>2</sub> </td>
					        			<td> <input class="form-control" id="modu1" type="text" maxlength="20"></td>
					        			<td> <input class="form-control" id="orie1" type="text" maxlength="20"><span> °</span></td>
					        		</tr>
					        	</tbody>
					        </table>		
					    </div>
					    ...
					    <div id="con" class="tab-pane fade">
							<div class="btn-group" data-toggle="buttons" id="conversion-boutons">
								 <label class="btn btn-default" id="radToDeg"> 
								 	<input type="radio" name="inlineRadioOptions" value="rad">rads <span class="glyphicon glyphicon-arrow-right"></span> degrees 
								 </label>
								 <label class="btn btn-default" id="degToRad"> 
								 	<input type="radio" name="inlineRadioOptions" value="deg">degrees <span class="glyphicon glyphicon-arrow-right"></span> rads
								 </label>
							</div>	 
							<p></p>
							<div class="input-group col-lg-10" id="angleConverti">
								<input id="entreeConversion" autofocus maxlength="23" style="text-align: right;" class="form-control" type="text" placeholder="Angle to be converted">
					    ...
					    <div id="mul" class="tab-pane fade">
					    	<span class="mode"><b>Product: </b> </span>
					    	<div class="btn-group" data-toggle="buttons">
								 <label class="btn btn-default" id="scalaire"> 
								 	<input type="radio" name="inlineRadioOptions" value="scalaire"> Dot 
								 </label>
								 <label class="btn btn-default" id="vectoriel"> 
								 	<input type="radio" name="inlineRadioOptions" value="vectoriel"> Cross
								 </label>
								 <label class="btn btn-default" id="mixte">
								 	<input type="radio" name="inlineRadioOptions" value="mixte"> Triple
								 </label>
							</div>
							<div id="resetInputs3">
								<button type="button" class="btn btn-default"> Empty table</button>
							...
							<div class="ajouterCompBox">			
								<button type="button" class="btn btn-primary" id="ajouterComp">Add 1 component</button>
							</div>
							<div class="enleverCompBox">
								<button type="button" class="btn btn-danger" id="enleverComp">Remove 1 component</button>	
							</div>
							<div class="afficherProduitBox">
								<button type="button" class="btn btn-success" id="afficherProduit">Display result</button> 
					   		</div>		
					    </div>
					    <!-- Vecteurs unitaires -->
					    <div id="uni" class="tab-pane fade">
							<p id="regle_uni">if <span class="italic">u = (u<sub>1</sub>, u<sub>2</sub>, ..., u<sub>n</sub>)</span> and <span class="italic">λ</span> is its unit direction vector <span class="italic">∈ ℛ <sup>n</sup> <br> λ = (u<sub>1</sub>, u<sub>2</sub>, ..., u<sub>n</sub>) / ||u||</span></p>
							<div id="resetInputs4">
								<button type="button" class="btn btn-default"> Empty table</button>
							</div>
							<div class="easter_eggs">
					        ...
					        <div id="unitaireBoutons">
						        <div class="ajouterCompBox">			
									<button type="button" class="btn btn-primary" id="ajouterComp2">Add 1 component</button>
								</div>
								<div class="enleverCompBox">
									<button type="button" class="btn btn-danger" id="enleverComp2">Remove 1 component</button>	
								</div>
								<div class="afficherProduitBox">
									<button type="button" class="btn btn-success" id="afficherResultat">Display result</button> 
						   		</div>
					   		</div>
					    </div>
						<!-- Alerte pi radians -->
						<div id="alertPi" class="alert alert-info alert-dismissible" role="alert">
						  ...
						  <strong>To use π, simply write "pi"<br> <span class="italic">Example: 5π/6<br> 5*pi/6 <span class="glyphicon glyphicon-ok"></span> ... 5pi/6 <span class="glyphicon glyphicon-remove"></span></span></strong>
						</div>
						<div id="boutons">
							...
							<div id="btn2">
								<div class="btn-group dropup">
								  <button type="button" class="btn btn-danger">Remove 1 vector</button>
							...
							<div id="btn3">
								<button type="button" class="btn btn-success">Display result</button>
							</div>
						</div>
					</div>
				</div>
			...
			<footer class="col-lg-12">
				<h3> Questions? Comments? <a href="faq-en.php">FAQ</a></h3>
				<p style="color: #2a64a7;"> Or ask questions on the facebook and twitter page!<a href="https://www.facebook.com/vectorsCalculator"><button class="btn btn-default"><img src="img/facebook.png" alt="facebook"/></button></a><a href="https://www.twitter.com/VectorCalculate"><button class="btn btn-default"><img src="img/twitter.png" alt="twitter"/></button></a></p>
